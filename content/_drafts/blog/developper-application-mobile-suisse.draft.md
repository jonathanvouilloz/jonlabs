# Tout ce qu'une PME romande doit savoir avant de commander une application mobile
...
<!-- TODO:image schema — Timeline 5 étapes : discovery, UX, développement, tests, lancement stores — brief: content/_drafts/blog/developper-application-mobile-suisse.md#image-3 -->
...
- **App Store Apple** : un compte développeur coûte **99 USD par an**. Le délai de validation de l'app par Apple est de **1 à 7 jours** (Apple peut refuser et demander des corrections). Prévoir ce délai dans ton planning.
- **Google Play** : un compte développeur coûte **25 USD une seule fois**. Le délai de validation est de **2 à 3 jours**.
...
<!-- TODO:image infographic — Tableau comparatif natif vs Flutter vs React Native vs PWA — brief: content/_drafts/blog/developper-application-mobile-suisse.md#image-2 -->
...
<!-- TODO:image infographic — Tableau fourchettes CHF par type d'app — brief: content/_drafts/blog/developper-application-mobile-suisse.md#image-4 -->
...
[**Discuter de votre projet mobile →**](/contact?utm_source=blog&utm_medium=article&utm_campaign=developper-application-mobile-suisse)
