...
La section Produits de GBP est distincte des Services — elle est faite pour les commerces qui vendent des articles physiques. Chaque produit : photo, nom, prix, description, lien vers la page produit sur ton site. Les produits apparaissent directement dans la fiche sur mobile — fort impact visual sur le CTR.
`[Signal : GBP 32%]`
...
Oui, pour deux raisons. Première raison : le signal Reviews représente 20% du Local Pack — chaque interaction avec un avis est un signal positif. Deuxième raison : les clients potentiels lisent les réponses aux avis positifs. Une réponse personnalisée montre que l'entreprise s'engage avec sa communauté.

### Les attributs d'identité ont-ils vraiment un impact sur le ranking ?

Oui, mais indirect. Les attributs (accessibilité, identité) ne sont pas des facteurs de ranking directs. Ils augmentent la visibilité dans les recherches filtrées ("restaurants accessibles en fauteuil roulant" par exemple) et améliorent le taux de clic depuis la fiche. Un CTR plus élevé → signal behavioral → meilleur ranking indirect.
...
[**Audit complet de ma fiche →**](/contact?utm_source=blog&utm_medium=article&utm_campaign=optimiser-fiche-google-my-business-checklist-2026)
