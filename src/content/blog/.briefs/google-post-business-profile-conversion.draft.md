...
<!-- TODO:image illustration — Tableau de bord Google Business Profile vue Posts avec exemple de post bien structuré — brief: src/content/blog/.briefs/google-post-business-profile-conversion.md#cover -->
...
<!-- TODO:image schema — Trois cartes comparatives des types de posts GBP : Mise à jour / Offre / Événement avec cas d'usage et CTA recommandés — brief: src/content/blog/.briefs/google-post-business-profile-conversion.md#image-2 -->
...
<!-- TODO:image schema — Framework V+S+R décomposé sur un exemple de post GBP, 3 blocs annotés Value/Scarcity/Redemption avec flèche "snippet mobile" — brief: src/content/blog/.briefs/google-post-business-profile-conversion.md#image-3 -->
...
<!-- TODO:image schema — URL UTM complète décomposée visuellement avec les 3 paramètres source/medium/campaign surlignés en couleurs distinctes — brief: src/content/blog/.briefs/google-post-business-profile-conversion.md#image-4 -->
...
- Claudia Tomina (GBP Product Expert) : Google Business Profile Posts Best Practices SOP (docs internes jonlabs)
