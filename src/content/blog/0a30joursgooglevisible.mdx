...
Tu veux pas y penser ? C'est exactement le genre de tâche qu'on peut automatiser. Un client passe en caisse, 2 heures plus tard il reçoit un SMS personnalisé avec le lien pour laisser un avis. Sans que tu lèves le petit doigt. Si ça t'intéresse, [j'en parle dans la section automatisation](/consultant-ia#automatisation).
