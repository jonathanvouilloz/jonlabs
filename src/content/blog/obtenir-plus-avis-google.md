---
title: "Obtenir plus d'avis Google : la méthode pour PME"
...
faqs:
  ...
  - question: "Que faire si un client promet un avis Google et ne le laisse pas ?"
    answer: "Tu peux relancer une seule fois, une semaine plus tard. Message court : 'Je voulais vérifier si le lien avait bien fonctionné, c'est ici : [lien].' Pas de relance en série. Certains clients oublient sincèrement, d'autres ne le feront jamais. Au-delà de deux contacts, tu génères de l'agacement, pas des avis."
  - question: "Comment automatiser la demande d'avis Google pour une PME ?"
    answer: "Avec Make ou Zapier : quand un rendez-vous passe au statut 'Terminé' dans ton outil de réservation (Calendly, Doctolib, SimplyBook), une attente de 2h déclenche un SMS automatique avec ton lien d'avis. Mis en place une fois, le flux tourne sans intervention. Configuration typique : 3 à 4h, zéro maintenance ensuite."
---
...
| Secteur | Moment idéal |
|---|---|
| Artisan (plombier, électricien) | Avant de partir, ou SMS dans l'heure |
| Restaurant / café | Addition ou message 1h après |
| Coiffeur / esthéticienne | Sur place, ou SMS dans les 2h |
| Cabinet médical / paramédical | SMS le soir même |
| Commerce de détail | QR code en caisse, avant de partir |
...
<!-- TODO:image schema — Courbe de satisfaction client dans le temps, pic surligné en vert = "demande ici", zone tardive en gris = "trop tard" — brief: content/_drafts/blog/obtenir-plus-avis-google.md#image-timing -->
...
**QR code en point de vente.** Pour les commerces physiques, restaurants et salons : un QR code sur le comptoir ou la note d'encaissement permet de laisser un avis sur le moment. La tactique détaillée (format, emplacement, taille, test multi-appareils) est dans l'article [collecter des avis avec un QR code](/blog/qr-code-avis-google-collecte-pme).
...
<!-- TODO:image infographic — 4 blocs brutalistes : lien court, QR code, SMS, email, chacun avec icône et "idéal pour : [type de business]" — brief: content/_drafts/blog/obtenir-plus-avis-google.md#image-canaux -->
...
Ce qui est autorisé : demander poliment à tous tes clients sans filtrer, utiliser QR code, lien court, SMS ou email, relancer une seule fois après une semaine, et répondre à tous tes avis. Pour ce dernier point, l'article sur [répondre systématiquement à tes avis](/blog/repondre-avis-google-modeles-2026) couvre le framework complet.

<!-- TODO:image infographic — Encadré "À NE PAS FAIRE" brutaliste, fond avec accent rouge, 3-4 pratiques interdites (contrepartie, review gating, faux avis, collecte données sans base LPD) avec icône interdit — brief: content/_drafts/blog/obtenir-plus-avis-google.md#image-interdits -->
